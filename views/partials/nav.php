        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="index.php" class=" <?php echo $_SERVER['REQUEST_URI'] === '/PHP-Laracast/index.php' ?  'bg-gray-900 text-white' : 'text-gray-300';?> hover:bg-gray-700 rounded-md  px-3 py-2 text-sm font-medium " aria-current="page">Home</a>
              <a href="/PHP-Laracast/about.php" class=" <?php echo $_SERVER['REQUEST_URI'] === '/PHP-Laracast/about.php' ?  'bg-gray-900 text-white' : 'text-gray-300';?>rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">About us</a>
              <a href="/PHP-Laracast/contact.php" class=" <?php echo $_SERVER['REQUEST_URI'] === '/PHP-Laracast/contact.php' ?  'bg-gray-900 text-white' : 'text-gray-300';?>rounded-md px-3 py-2 text-sm font-medium hover:bg-gray-700 hover:text-white">Contact</a>
